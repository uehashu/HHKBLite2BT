...
// To connect HEF4514B
#define COL_SELECTPIN0 4 // pin A0
#define COL_SELECTPIN1 5 // pin A1
#define COL_SELECTPIN2 6 // pin A2
#define COL_SELECTPIN3 7 // pin A3

// To connect CD4512BP
#define ROW_SELECTPIN0  8 // pin A
#define ROW_SELECTPIN1  9 // pin B
#define ROW_SELECTPIN2 10 // pin C
#define ROW_INPUTPIN   11 // input

// Function key(fn) position
#define FNKEY_POSITION_COL 12
#define FNKEY_POSITION_ROW  7
...
const boolean COL_SWEAPBITS[COL][4] = 
  ...
  {{ LOW, LOW, LOW, LOW},  // output O0
   ...
   {HIGH, LOW,HIGH, LOW},  // output O10
   {HIGH, LOW,HIGH,HIGH},  // output O12
...
const byte KEYID_PLAIN[COL][ROW] = 
  {{0x2c,0x28,0x00,0x31,0x4c,0x00,0x00,0x00},
...
const byte KEYID_FN[COL][ROW] = 
  {{0x2c,0x28,0x00,0x49,0x2a,0x00,0x00,0x00},
   {0xe6,0x00,0xe2,0x00,0x00,0x00,0x00,0x00},
   {0x00,0xe5,0x00,0x00,0xe1,0x00,0x00,0x00},
   {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe0},
   {0x00,0x1d,0x29,0x04,0x39,0x14,0x3a,0x4c},
